<%-- 
    Document   : repexpediente
    Created on : 30-jun-2012, 22:43:47
    Author     : miky
--%>
...
File reportFile = new File(application.getRealPath("reportes//expediente.jasper"));
...
parameters.put("dni",request.getParameter("dni") );
