...
<ul class="menu">
	...
	<li >
		<a href="con_es_tra.jsp?tra=<% out.print(cTramite.getN_tramite()); %>">		<span>Detalle de Tr&aacute;mite</span>
		</a>
	</li>
	<li >
		<a href="../reportes/repexpediente.jsp?dni=<% out.print(cUsu.getDni()); %>" target="_blank">
			<span>Reporte Expediente</span>
		</a>
	</li>
</ul>
</div><!--/nav-->
...
<div class="grilla">
       <table width="651" height="67" border="0" cellpadding="0" cellspacing="0" class="sortable" id="table">
		<thead>
			<tr>
				<th width="107" class="nosort"><h3>Num.</h3></th>
				<th width="140"><h3>Tipo de Tramite</h3></th>
				<th width="147"><h3>Fecha</h3></th>
				<th width="256"><h3>Asunto</h3></th>
			  </tr>
		</thead>
		<tbody>
                    <%
                        ArrayList<tramite> lTramite= cTramite.listar();
                         ...
                         <tr>
                           <% cTramite=(tramite)iterator.next(); %>
                           <td><a href="con_es_tra.jsp?tra=<% out.print(cTramite.getN_tramite()); %>"  style="text-decoration:none; color:#0000cc;"> 
                           <% out.print(cTramite.getN_tramite()); %></a></td>
				<td><%
                                cTipTramite.setIdTipo_tramite(cTramite.getTip_tram());
                                cTipTramite.buscar();
                                out.print(cTipTramite.getNombre()); %></td>
				<td><% out.print(cTramite.getFecha()); %></td>
				<td><% out.print(cTramite.getAsunto()); %></td>
