...
<tr>
	...
	<br /><br />
    <div id="mostrar">
	<form action="agregar_tip_t.jsp" method="post" name="emailForm" id="emailForm" class="form-validate">
    ...
    <table class="lista">
            ...
            <%
                ...
                <tr >
			<td><div align="center"><% out.print(cTip_t.getIdTipo_tramite()); %></div></td>
			<td><% out.print(cTip_t.getNombre()); %></td>
			<td><% out.print(cTip_t.getAbrev()); %></td>

			<td valign="top">
                            <a onclick="seleccionar('seleccionar_tip_t.jsp',<% out.print(cTip_t.getIdTipo_tramite()); %>);">Editar</a>
                            <a onclick="if(confirm('Seguro que deseas Eliminar')) {location.href='eliminar_tip_t.jsp?id=<% out.print(cTip_t.getIdTipo_tramite()); %>' } ">Eliminar</a>
			  </td>
		</tr>
		<% } %>
