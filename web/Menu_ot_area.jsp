...
<table>
        ...
        <%
            ...
            ArrayList<tramite_movimiento> lTram= cTram.listar_x_oficina();
...
<section id="badges"></section>
    ...
    <div id="testContent" style="display: none">
        ...
        out.print(c2.get(Calendar.YEAR)+"-"+c2.get(Calendar.MONTH)+"-"+c2.get(Calendar.DATE)); %></p>
			...
			<p>	
			  <input type="submit" name="button_el" value="Derivar" id="button_el" onClick="raiz_oa()"   />
